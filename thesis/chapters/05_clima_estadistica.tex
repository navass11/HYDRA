...
Sobre cada isolínea de período de retorno se calcula el \emph{Evento de Diseño de Máxima Probabilidad} (\textsc{mpde}, \emph{Maximum Probability Design Event}): el punto de la isolínea con mayor densidad de probabilidad conjunta, estimado como el máximo del producto de la densidad de la cópula por las densidades marginales \parencite{salvadori2007extremes}. El \textsc{mpde} es el escenario de diseño más probable entre todos los que comparten un mismo período de retorno conjunto y constituye el candidato natural cuando se necesita un único vector de variables de entrada para el modelo hidráulico. La \cref{fig:copula_joint_ret} muestra un ejemplo de estas isolíneas AND y OR con sus respectivos \textsc{mpde} sobre un dataset sintético de caudal máximo y nivel del mar. La herramienta web de \hydra expone este análisis de forma interactiva mediante la aplicación \emph{Eventos Compuestos} disponible en el módulo \texttt{/tools/compound}.
...
Ambos métodos fueron aplicados en los estudios de los países andinos \parencite{paz2019idb,deljesus2020andinos} y en SIMPCCe \parencite{navas2025simpce,fundacioncanal2022guiaembalses}, con proyecciones CMIP5 y CMIP6 respectivamente.
