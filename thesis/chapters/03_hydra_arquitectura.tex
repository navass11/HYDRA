...
El paquete \pyhydra está disponible como repositorio propio en \href{https://github.com/navass11/pyhydra}{GitHub: \texttt{navass11/pyhydra}} e instalable mediante \texttt{pip install -e .} desde su raíz. La versión 0.1.0 se ha archivado como software en Zenodo \parencite{navas2026pyhydra}, que constituye la referencia durable del núcleo Python. Su estructura sigue el patrón estándar de paquetes Python modernos: módulos temáticos con \texttt{\_\_init\_\_.py} que exponen la API pública de cada subpaquete, y un fichero \texttt{utils.py} en la raíz con funciones transversales. El repositorio de integración \hydra, disponible en \href{https://github.com/navass11/HYDRA}{GitHub: \texttt{navass11/HYDRA}} \parencite{navas2026hydrarepo}, consume ese paquete como núcleo y añade las capas de ejecución, web y documentación reproducible. Durante la tesis se mantuvo además una instancia de demostración desplegada en la nube, documentada en el \texttt{README.md} del repositorio; se trata de un endpoint efímero de validación operativa y no se referencia aquí como fuente durable.
