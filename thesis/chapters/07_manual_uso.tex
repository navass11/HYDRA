...
El patrón de uso es común, aunque no idéntico, en todos los módulos: preparar los datos en formatos internos de \pyhydra, llamar a las funciones de configuración, ejecutar el motor y, cuando existe lector implementado, recuperar resultados mediante funciones de postprocesado. Los adaptadores reducen la exposición directa al formato propietario de cada motor y mantienen contratos de entrada y salida compatibles con el análisis estadístico; no eliminan las diferencias entre motores ni sustituyen la revisión técnica de cada modelo. Los notebooks de ejemplo documentan configuraciones completas para los casos del Besaya (HEC-HMS + SFINCS), Calle 30 (HEC-HMS + HEC-RAS) y SIMPCCe (SWAT); la referencia de parámetros se recoge en el \cref{app:api}.
