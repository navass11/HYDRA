...
La gobernanza del software sigue el ciclo ya aplicado en la versión 0.1.0: desarrollo en repositorios Git con revisión de cambios, publicación de versiones etiquetadas con changelog, y depósito de cada versión estable en Zenodo con DOI propio (\pyhydra: 10.5281/zenodo.20932555; \hydra: 10.5281/zenodo.21138151), lo que garantiza la citabilidad y la correspondencia verificable entre los resultados de esta memoria y el código que los produce. IHCantabria asume el mantenimiento del proyecto como parte de su cartera de herramientas de transferencia; la distribución en PyPI y la apertura progresiva a contribuciones externas se recogen en el trabajo futuro (\cref{ch:conclusiones}).
