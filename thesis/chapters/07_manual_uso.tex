...
\begin{table}[htbp]
  ...
  \begin{tabular}{@{}>{\raggedright\arraybackslash}p{0.24\textwidth}>{\raggedright\arraybackslash}p{0.17\textwidth}>{\raggedright\arraybackslash}p{0.24\textwidth}>{\raggedright\arraybackslash}p{0.23\textwidth}@{}}
    ...
    \midrule
    Ajuste GEV y comparación de estimadores & Completo & Ninguna; datos sintéticos incluidos & Figura 5.1, parámetros ajustados e intervalos \\
...
\begin{description}
  \item[Hidrología.] \texttt{modeling.hydrology.hec\_hms} envuelve HEC-HMS con funciones de preparación de entradas meteorológicas, escritura en formato DSS, parametrización automática a partir de datos geoespaciales (curva número, tiempo de concentración, Muskingum) y lectura de resultados. \texttt{modeling.hydrology.swat} implementa funciones para preparar ficheros de forzamiento de SWAT/SWAT+, ajustar el período de simulación y lanzar el ejecutable; la lectura genérica de salidas SWAT no forma parte todavía de la API pública.
