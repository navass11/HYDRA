...
Todos los módulos de \pyhydra siguen un contrato de tipos que garantiza la interoperabilidad entre bloques sin conversiones manuales, resumido en la \cref{tab:tipos_internos}:
...
Cada producto relevante debe conservar los metadatos mínimos que recoge la \cref{tab:metadatos} para que sea auditable o reproducible por un tercero:
...
\begin{table}[htbp]
  ...
  \begin{tabular}{p{0.22\textwidth}p{0.60\textwidth}}
    ...
    Corrección de sesgo & Método (delta, EQM, QDM, SDM), variable, escenario, modelos usados, período histórico de referencia. \\[3pt]
