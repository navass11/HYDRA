...
Cada notebook indica en su primera celda los requisitos específicos de datos, credenciales y software. La \cref{tab:requisitos_notebooks} resume los requisitos no triviales que afectan a varios notebooks:
