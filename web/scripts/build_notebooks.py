...
CATEGORIES = {
    ...
    "pilot_cases/los_corrales_buelna/09_uncertainty_propagation_strategy": ("Caso piloto", "⑨"),
    "pilot_cases/valencia_dana/01_data_exploration":                     ("Caso piloto", "①"),
    "pilot_cases/valencia_dana/02_extreme_value_analysis":               ("Caso piloto", "②"),
    "pilot_cases/valencia_dana/03_real_regional_study_pyhydra":          ("Caso piloto", "③"),
...
TITLES = {
    ...
    "pilot_cases/los_corrales_buelna/09_uncertainty_propagation_strategy": "Besaya 09 · pyhydra.uq",
    ...
    "pilot_cases/valencia_dana/03_real_regional_study_pyhydra":          "DANA 03 · Regional PyMC",
