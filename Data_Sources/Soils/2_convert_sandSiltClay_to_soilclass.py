...
# 2. Define file locations
# fixed
file_path = Path("E:/SURINAM/01_DATA/04_DATOS_GEOGRAFICOS/02_SOIL/")
file_clay = 'CLYPPT_M_'
file_sand = 'SNDPPT_M_'
file_silt = 'SLTPPT_M_'
file_end = '_250m_ll.tif'
file_path_des = Path("E:/SURINAM/01_DATA/04_DATOS_GEOGRAFICOS/02_SOIL/USDA/")
