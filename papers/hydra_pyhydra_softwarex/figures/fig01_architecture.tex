...
\begin{tikzpicture}[
  ...
  box/.style={rounded corners=2pt, line width=0.8pt, align=left,
    minimum height=25mm, text width=50mm, inner sep=3mm},
...
\node[box, draw=methodteal, fill=methodteal!8, right=6mm of data] (methods) {
...
\node[box, draw=modelorange, fill=modelorange!8, right=6mm of methods] (models) {
...
\node[layer, draw=black!55, fill=softgray, below=8mm of methods] (exchange) {
...
\draw[arrow] (methods.south) -- (exchange.north);
\draw[arrow] (models.south) -- ++(0,-3mm) -| (exchange.north east);
\draw[arrow] (exchange) -- (core);
\draw[arrow] (core) -- (hydra);

\node[fit=(data)(methods)(models)(exchange)(core), inner sep=3mm,
